...
struct SettingsGoofyView: View {
  ...
  @AppStorage("confetti", store: UserDefaults(suiteName: "group.com.sugarhashira.Escudo")) var confetti:
    Bool = false

  //    @AppStorage("chromatic", store: UserDefaults(suiteName: "group.com.sugarhashira.Escudo")) var chromatic: Bool = false

  @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: "group.com.sugarhashira.Escudo"))
  var lineGraph: Bool = false

  @AppStorage("budgetViewStyle", store: UserDefaults(suiteName: "group.com.sugarhashira.Escudo"))
  var budgetRows: Bool = false

  @AppStorage("swapTimeLabel", store: UserDefaults(suiteName: "group.com.sugarhashira.Escudo"))
