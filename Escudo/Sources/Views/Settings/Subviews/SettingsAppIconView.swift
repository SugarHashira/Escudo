...
struct SettingsAppIconView: View {
  @AppStorage("activeIcon", store: UserDefaults(suiteName: "group.com.sugarhashira.Escudo"))
  ...
  let options: [AppIconBundle] = [
    ...
    AppIconBundle(
      ...
      displaySubtitle: "Just a fun alternate icon — because why not."),
    AppIconBundle(
    ...
    AppIconBundle(
      ...
      displaySubtitle: "The original Escudo icon.")
  ]
