...
struct NewCategoryPickerView: View {
    ...
    var filteredCategories: [Category] {
        categories.filter { isIncome ? $0.usedForIncome : $0.usedForExpense }
    }
    ...
    init(
        ...
        // Fetch all categories sorted by order; filter by usedForExpense/usedForIncome in filteredCategories
